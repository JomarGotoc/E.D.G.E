...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="Create_Deped_Account.php">Create Accounts</a>
    ...
    <div class="login-container">
        ...
        if (isset($_POST["submit"])) {
           ...
           $errors = array();
            ...
            $sql = "INSERT INTO deped_admin (idnum, password, date, region) VALUES ( ?, ?, ?, ?)";
        ...
        <form class="login-form" action="Create_Deped_Account.php" method="post">
            <div class="row">
                <div class="columns">
