...
<body>
    ...
    <div class="login-container">
        ...
        <div class="buttons">
            <a href="Create_Deped_Account.php"><button class="button">DepEd Admin</button></a>
            <a href="Create_Division_Account.php"><button class="button">Division Admin</button></a>
        </div>
    </div>
</body>
</html>
