...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql_update = "UPDATE students SET fullname='$new_full_name', lrn='$new_lrn', phone='$new_phone', section='$new_section' WHERE id=$id";

    if ($conn->query($sql_update) === TRUE) {
        header("Location: view_studentlist2.php");
    } else {
...
<div class="login-container">
        <a href="view_studentlist2.php" class="back-icon"><i class='bx bxs-chevron-left'></i></a>
        <div class="logo"></div>
        ...
        <form class="login-form" action="" method="post">
            <div class="row">
                <div class="columns">
                    ...
                    <div class="form-group">
                        <label for="idnum">LRN</label>
                        <input type="text" id="idnum" name="lrn" value="<?php echo $id; ?>" required>
                    </div>
                </div>
                ...
                <div class="columns">
                    <div class="form-group">
                        ...
                        <input type="text" id="sec" name="section" value="<?php echo $section; ?>" required>
                    </div>
                    <div class="form-group">
