...
if (isset($_GET['id'])) {
    ...
    $sql = "DELETE FROM `guidance` WHERE `id`='$user_id'";
    ...
    <div class="main-container">
        ...
        <div class="filter-popup" id="filter-popup">
            ...
            ?>
                ...
                <td class="rows"><?php echo $row['idnum']; ?></td>
                <td class="rows"><?php echo $row['password']; ?></td>
                <td class="rows"><?php echo $row['date']; ?></td>
                    <td class="rows">
                        <div class="button-container">
                        <a href="counselor_account_edit.php?id=<?php echo $row['id']; ?>"><button class="edit-button">Edit</button></a>
                        <a href="counselor_account.php?id=<?php echo $row['id']; ?>"><button class="delete-button">Delete</button></a>
                        </div>
                    </td>
