        ...
        <?php
          $errors = array();
            if($_POST)
            {
                ...
                $query="SELECT * From deped_admin where idnum='$idnum' and password='$password'";
                $result=mysqli_query($conn,$query);

                if(mysqli_num_rows($result)>0)
                {
                    header('location:DepEd.php');
                }
          ...
          ?>
        <form class="login-form" action="Deped_Admin_Login.php" method="post">
