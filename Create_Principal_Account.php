...
<body>
    ...
    <div class="login-container">
        ...
        if (isset($_POST["submit"])) {
           ...
           if(empty($fullname) || empty($idnum) ||  empty($password) ||  empty($date) ||  empty($region)){
            ...
            $sql = "INSERT INTO principal (fullname, idnum, password, date, region) VALUES ( ?, ?, ?, ?, ?)";
            $stmt = mysqli_stmt_init($conn);
            $prepareStmt = mysqli_stmt_prepare($stmt,$sql);
            if ($prepareStmt) {
                mysqli_stmt_bind_param($stmt,"sssss",$fullname, $idnum, $hashedPassword, $date, $region);
        ...
        <form class="login-form" action="Create_Principal_Account.php" method="post">
            <div class="row">
                <div class="columns">
                ...
                <div class="columns">
                    ...
                    <div class="form-group">
                        <label for="topdown">Region</label>
                        <select id="topdown" name="region" >
