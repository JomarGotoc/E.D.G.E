...
$sql_select_user = "SELECT * FROM principal WHERE id=$id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql_update = "UPDATE principal SET fullname='$new_full_name', password='$new_password', idnum='$new_idnum', date='$new_date' WHERE id=$id";
