...
<body>
    ...
    <div class="main-container">
        <div class="inner-container">
            ...
            <div class="middle-inner-container"><h3>Department of Education SDO School Administrators</h3></div>
            <div class="bottom-inner-container"></div>

            <div class="bottom-inner-container2">
                <div class="column"><h3>School Name<i class='bx bx-filter-alt'></i></h3></div>
                <div class="column"><h3>ID Number</h3></div>
                <div class="column"><h3>Phone Number</h3></div>
        ...
        <div class="filter-popup" id="filter-popup">
            ...
            <table class="table">
                <tr class="sheshable">
                    ...
                    <td class="rows">Lasip Grande</td>
                    <td class="rows">
                        <div class="button-container">
                            <a href="DepEd_manageaccount2_edit.php"><button class="edit-button">Edit</button></a>
