...
<body>
  ...
  <header>
    ...
    <div class="login-container">
        ...
        <div class="buttons">
            <a href="Create_SDO_Account.php"><button class="button">SDO Administrator</button></a>
            <a href="Create_SI_Account.php"><button class="button">Superintendent</button></a>
            <a href="Select_School.php"><button class="button">School Administrator</button></a>
        </div>
    </div>
</body>
</html>
