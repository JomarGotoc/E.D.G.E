...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="Principal_VPR.php" id="">View Period Reports</a>
            <a href="Principal_VOR.php" id="">View Overall Reports</a>
        </nav>
    </div>
